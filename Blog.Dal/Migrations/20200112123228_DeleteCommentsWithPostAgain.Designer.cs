...
namespace Blog.Dal.Migrations
{
    ...
    [Migration("20200112123228_DeleteCommentsWithPostAgain")]
    partial class DeleteCommentsWithPostAgain
    {
            ...
            modelBuilder.Entity("Blog.Dal.Models.BlogEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreationDate = new DateTime(2020, 1, 12, 13, 32, 27, 801, DateTimeKind.Local), ModificationDate = new DateTime(2020, 1, 12, 13, 32, 27, 801, DateTimeKind.Local), Title = "Programming Blog", UserId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("Blog.Dal.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ActivationCode = "CDN8", CreationDate = new DateTime(2020, 1, 12, 13, 32, 27, 798, DateTimeKind.Local), Email = "tomasz.komoszeski@gmail.com", FirstName = "Tomasz", IsActive = true, LastName = "Komoszeski", ModificationDate = new DateTime(2020, 1, 12, 13, 32, 27, 800, DateTimeKind.Local), Password = "d9d420ec1652e5a5a826432a363c45bc2622aaf6725188c8a4c826bf68a5675f", Role = "Administrator", Username = "Tomasz" }
                    );
                });
